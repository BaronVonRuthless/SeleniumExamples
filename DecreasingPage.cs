...
namespace SolutionBuilderClientDetailsTESTS
{
    ...
    public class DecreasingPage : TestBase
    {
        #region Support Methods

        //Get to DTA Page
        public void RouteToDTA(IWebDriver driver)
        {
            ...
            Assert.IsTrue(driver.FindElement(By.Id("dtaTermnew")).Displayed);
        }
        ...
        public void LinkToDashboardDTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);

            //Use Route To DTA to get to DTA Page:
            var setupRoute = new DecreasingPage();
            setupRoute.RouteToDTA(driver);
        ...
        public void ClientHistoryButtonDTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
        ...
        public void AddClientButtonDTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
        ...
        public void MyServicesLinkDTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
        ...
        public void LogoutButtonDTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
        ...
        public void ViewEditClientButtonDTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
        ...
        public void IndicativePremiumGenerationDTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            ...
            var inputDTAValues = new DecreasingTermPageObjects();
            string termYears = Constants.dtaTERMYEARS;
            inputDTAValues.DTATermYears(driver, termYears);
            inputDTAValues.DTALevelTermSelect(driver);
            string levelTermValue = Constants.dtaTERMVALUE;
            inputDTAValues.DTALevelTermAmount(driver, levelTermValue);
        ...
        public void CancelButtonDTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            ...
            //Validate client details page reached - Find field and ensure contains "Mr"
            Assert.IsTrue(driver.FindElement(By.Id("select-benefit-dta")).Displayed);
        ...
        public void FormValidationStandardDTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            ...
            .Until(ExpectedConditions.ElementExists(By.XPath(".//*[@id='dtaFormnew']/div[2]/div/div[2]")));

            //Assert that headedr text is shown
            string headerValidationText = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[2]/div/div[2]")).Text.Trim();
            ...
            string lifeAmountDisabled = driver.FindElement(By.Id("dtaLifeCoverAmountnew")).GetAttribute(attributeNameDisabled);
            Assert.AreEqual(lifeAmountDisabled, "true");

            //CLick the tickbox
            var lifeCoverAmount = driver.FindElement(By.Id("dtaLifeCoverBasisnew"));
            lifeCoverAmount.Click();

            //CHeck that the field is now accepting values
            string attributeNameRequired = "required";
            string lifeEnterAmount = driver.FindElement(By.Id("dtaLifeCoverAmountnew")).GetAttribute(attributeNameRequired);
            Assert.AreEqual(lifeEnterAmount, "true");

            //Assert that error text is displayed:
            string validationTextLife = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[8]/div[2]")).Text.Trim();
            ...
            var lifeEnterAmountField = driver.FindElement(By.Id("dtaLifeCoverAmountnew"));
            ...
            string cicAmountDisabled = driver.FindElement(By.Id("dtaCriticalIllnessAmountnew")).GetAttribute(attributeNameDisabled);
            Assert.AreEqual(cicAmountDisabled, "true");

            //CLick the CIC cover tick box
            var criticalIllnessCoverAmount = driver.FindElement(By.Id("dtaCriticalIllnessCoverBasisnew"));
            criticalIllnessCoverAmount.Click();

            //Assert that error text is displayed:
            string validationTextCIC = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[9]/div[2]")).Text.Trim();
            Assert.AreEqual(validationTextCIC, "Please enter a whole number between 1,000 and 5,000,000");

            //CHeck that the field is now accepting values
            string cicEnterAmount = driver.FindElement(By.Id("dtaCriticalIllnessAmountnew")).GetAttribute(attributeNameRequired);
            Assert.AreEqual(cicEnterAmount, "true");

            //Insert premium info CIC cover amount
            var criticalInputAmount = driver.FindElement(By.Id("dtaCriticalIllnessAmountnew"));
            ...
            string lifeAndCicButtonDisabled = driver.FindElement(By.Id("dtaLifeOrCriticalIllnessCoverBasisnew")).GetAttribute(attributeNameDisabled);
            Assert.AreEqual(lifeAndCicButtonDisabled, "true");
            
            //Assert that input field is disabled
            string lifeAndCicAmountDisabled = driver.FindElement(By.Id("dtaLifeCoverOrEarlierCIAmountnew")).GetAttribute(attributeNameDisabled);
            ...
            var unselectCriticalIllnessCoverAmount = driver.FindElement(By.Id("dtaCriticalIllnessCoverBasisnew"));
            unselectCriticalIllnessCoverAmount.Click();

            //Select tickbox to activate Life or earlier CI cover amoun
            var lifeOrEarlierCICoverAmoun = driver.FindElement(By.Id("dtaLifeOrCriticalIllnessCoverBasisnew"));
            ...
            //Assert that error text is displayed:
            string validationTextLifeCIC = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[10]/div[2]/span[1]")).Text.Trim();
            ...
            string cicButtonDisabled = driver.FindElement(By.Id("dtaCriticalIllnessCoverBasisnew")).GetAttribute(attributeNameDisabled);
            Assert.AreEqual(cicButtonDisabled, "true");

            //Assert that input field is disabled
            string cicAmountDisabledAgain = driver.FindElement(By.Id("dtaCriticalIllnessAmountnew")).GetAttribute(attributeNameDisabled);
            Assert.AreEqual(cicAmountDisabledAgain, "true");

            //Insert premium into life & Critical illness cover amount
            var lifeAndCicInputAmount = driver.FindElement(By.Id("dtaLifeCoverOrEarlierCIAmountnew"));
            ...
            string validationText = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[6]/div[2]/span")).Text.Trim();
            ...
            var usernameField = driver.FindElement(By.Id("dtaTermnew"));
            usernameField.Clear();
            usernameField.SendKeys("15");

            //Check that error text "please enter a number..." has been removed.
            bool enterNumberTextNull = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[6]/div[2]/span")).Displayed;
            Assert.IsFalse(enterNumberTextNull);

            //Assert the message on the top of the page changes to the Thnak You text:
            string validationHeaderComplete = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[2]/div/div[3]")).Text.Trim();
        ...
        public void FormValidationXraeDTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            ...
            lifeCoverAmount.Click();
            //Insert number of years in Term
            var termField = driver.FindElement(By.Id("dtaTermnew"));
            termField.Clear();
            ...
            var xraeYesButton = driver.FindElement(By.Id("dtaHeightAndHeightYesnew"));
            xraeYesButton.Click();

                                //   * * *  M E T R I C  * * *  //

            //Assert Xrea button functionality for First Life
            driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[15]")).FindElement(By.Id("hwMetric")).Click();
            ...
            string xraeValidationInvalidHeightErrorText = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[2]/span")).Text.Trim();
            Assert.Contains(xraeValidationInvalidHeightErrorText, "Height must be between 122cm and 241cm");
            // and
// fails    string xraeValidationMissingWeightErrorText = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[2]/span")).Text.Trim();
// fails    Assert.Contains(xraeValidationMissingWeightErrorText, "Height and weight must be supplied together or not at all");
            ...
            bool xraeValidationErrorTextNullHeight = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[2]/span")).Displayed;
            ...
            string xraeValidationInvalidWeightErrorText = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[2]/span")).Text.Trim();
            ...
            metricHeightValue.Clear();
            string xraeValidationMissingHeightErrorText = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[2]/span")).Text.Trim();
            ...
            bool xraeValidationErrorTextNullWeight = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[2]/span")).Displayed;
            Assert.IsFalse(xraeValidationErrorTextNullWeight);


            //Assert the message on the top of the page changes to the Thnak You text:
            ////Insert valid Height
            var metricValidHeightValue2 = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[15]")).FindElement(By.Id("hw.heightCentimetres"));
            ...
            driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[16]")).FindElement(By.Id("hwMetric")).Click();
            driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[16]")).FindElement(By.Id("hwImperial")).Click();
...
// fails    string xraeValidationInvalidHeightFeetErrorText = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[3]/span")).Text.Trim();
// fails    Assert.Contains(xraeValidationInvalidHeightFeetErrorText, "Height must be between 4ft 0in and 7ft 11in");
            // and
            string xraeValidationMissingWeightErrorText = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[3]/span")).Text.Trim();
            ...
            string xraeValidationInvalidHeightInchesErrorText = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[3]/span")).Text.Trim();
...
// fails    bool xraeValidationErrorTextNullImperialHeight = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[2]/span")).Displayed;
...
// fails    string xraeValidationInvalidWeightStoneErrorText = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[3]/span")).Text.Trim();
...
// fails    string xraeValidationMissingWeightPoundsErrorText = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[3]/span")).Text.Trim();
// fails    Assert.Contains(xraeValidationMissingWeightPoundsErrorText, "Both stone and pounds must be specified");            
            ...
            var imperialWeightPoundsValue = driver.FindElement(By.XPath(".//*[@id='dtaFormnew']/div[16]")).FindElement(By.Id("hw.weightPounds"));
