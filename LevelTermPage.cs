...
namespace SolutionBuilderClientDetailsTESTS
{
    ...
    public class LevelTermPage : TestBase
    {
        #region Support Methods

        //Get to LTA Page
        public void RouteToLTA(IWebDriver driver)
        {
        ...
        public void LinkToDashboardLTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            //var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);

            //Use Route To LTA to get to LTA Page:
            var setupRoute = new LevelTermPage();
            setupRoute.RouteToLTA(driver);
        ...
        public void ClientHistoryButtonLTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            //var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
        ...
        public void AddClientButtonLTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            //var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
        ...
        public void MyServicesLinkLTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            //var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
        ...
        public void LogoutButtonLTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            //var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
        ...
        public void ViewEditClientButtonLTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            //var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
        ...
        public void IndicativePremiumGenerationLTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            //Setup
            //var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            ...
            var common = new CommonSolutionBuilderPageObjects();
            var benefit = new BenefitSelectionPageObjects();
            var lta = new LevelTermPageObjects();
            string benefitId = "lta";
            ...
            var blankIndicativePremium = common.BenefitIndicativePremiumReader(driver, benefitId);
            ...
            lta.LTAMinimalBenefitDetails(driver, termYears, levelTermValue);

            //Check indicative field again and confirm value has updated
            var newIndicativePremium = common.BenefitIndicativePremiumReader(driver, benefitId);
            ...
            var returnTotalValue = benefit.TotalIndicativePremiumReader(driver);
        ...
        public void CancelButtonLTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            //var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            ...
            //Validate client details page reached - Find field and ensure contains "Mr"
            Assert.IsTrue(driver.FindElement(By.Id("select-benefit-lta")).Displayed);
        ...
        public void FormValidationStandardLTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            //var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            ...
            .Until(ExpectedConditions.ElementExists(By.XPath(".//*[@id='ltaFormnew']/div[2]/div/div[2]")));
            
            //Assert that headedr text is shown
            string headerValidationText = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[2]/div/div[2]")).Text.Trim();
            ...
            string lifeAmountDisabled = driver.FindElement(By.Id("ltaLifeCoverAmountnew")).GetAttribute(attributeNameDisabled);
            Assert.AreEqual(lifeAmountDisabled, "true");

            //CLick the tickbox
            var lifeCoverAmount = driver.FindElement(By.Id("ltaLifeCoverBasisnew"));
            lifeCoverAmount.Click();

            //CHeck that the field is now accepting values
            string attributeNameRequired = "required";
            string lifeEnterAmount = driver.FindElement(By.Id("ltaLifeCoverAmountnew")).GetAttribute(attributeNameRequired);
            ...
            string cicAmountDisabled = driver.FindElement(By.Id("ltaCriticalIllnessAmountnew")).GetAttribute(attributeNameDisabled);
            Assert.AreEqual(cicAmountDisabled, "true");

            //CLick the CIC cover tick box
            var criticalIllnessCoverAmount = driver.FindElement(By.Id("ltaCriticalIllnessCoverBasisnew"));
            criticalIllnessCoverAmount.Click();

            //Assert that error text is displayed:
            string validationTextCIC = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[9]/div[2]/span[1]")).Text.Trim();
            Assert.AreEqual(validationTextCIC, "Please enter a whole number between 1,000 and 5,000,000");

            //CHeck that the field is now accepting values
            string cicEnterAmount = driver.FindElement(By.Id("ltaCriticalIllnessAmountnew")).GetAttribute(attributeNameRequired);
            Assert.AreEqual(cicEnterAmount, "true");

            //Insert premium info CIC cover amount
            var criticalInputAmount = driver.FindElement(By.Id("ltaCriticalIllnessAmountnew"));
            ...
            string lifeAndCicButtonDisabled = driver.FindElement(By.Id("ltaLifeOrCriticalIllnessCoverBasisnew")).GetAttribute(attributeNameDisabled);
            Assert.AreEqual(lifeAndCicButtonDisabled, "true");
            
            //Assert that input field is disabled
            string lifeAndCicAmountDisabled = driver.FindElement(By.Id("ltaLifeCoverOrEarlierCIAmountnew")).GetAttribute(attributeNameDisabled);
            ...
            var unselectCriticalIllnessCoverAmount = driver.FindElement(By.Id("ltaCriticalIllnessCoverBasisnew"));
            unselectCriticalIllnessCoverAmount.Click();

            //Select tickbox to activate Life or earlier CI cover amoun
            var lifeOrEarlierCICoverAmoun = driver.FindElement(By.Id("ltaLifeOrCriticalIllnessCoverBasisnew"));
            ...
            //Assert that error text is displayed:
            string validationTextLifeCIC = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[10]/div[2]/span[1]")).Text.Trim();
            ...
            string cicButtonDisabled = driver.FindElement(By.Id("ltaCriticalIllnessCoverBasisnew")).GetAttribute(attributeNameDisabled);
            Assert.AreEqual(cicButtonDisabled, "true");

            //Assert that input field is disabled
            string cicAmountDisabledAgain = driver.FindElement(By.Id("ltaCriticalIllnessAmountnew")).GetAttribute(attributeNameDisabled);
            Assert.AreEqual(cicAmountDisabledAgain, "true");

            //Insert premium into life & Critical illness cover amount
            var lifeAndCicInputAmount = driver.FindElement(By.Id("ltaLifeCoverOrEarlierCIAmountnew"));
            ...
            string validationText = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[6]/div[2]/span")).Text.Trim();
            ...
            var usernameField = driver.FindElement(By.Id("ltaTermnew"));
            usernameField.Clear();
            usernameField.SendKeys("15");

            //Check that error text "please enter a number..." has been removed.
            bool enterNumberTextNull = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[6]/div[2]/span")).Displayed;
            Assert.IsFalse(enterNumberTextNull);

            //Assert the message on the top of the page changes to the Thnak You text:
            string validationHeaderComplete = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[2]/div/div[3]")).Text.Trim();
        ...
        public void FormValidationXraeLTA(string appiumVersion, string browserName, string version, string platform, string platformVersion, string platformName, string deviceName, string deviceOrientation)
        {
            // Call Setup
            //var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            var driver = Setup(appiumVersion, browserName, version, platform, platformVersion, platformName, deviceName, deviceOrientation);
            ...
            setupRoute.RouteToLTA(driver);
                ...
                lifeCoverAmount.Click();
                    //Insert number of years in Term
                var termField = driver.FindElement(By.Id("ltaTermnew"));
                termField.Clear();
            ...
            var xraeYesButton = driver.FindElement(By.Id("ltaHeightAndHeightYesnew"));
            new CommonSupportObjects().TabletClick(xraeYesButton, driver);

                                //   * * *  M E T R I C  * * *  //

            //Assert Xrea button functionality for First Life
            driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[15]")).FindElement(By.Id("hwMetric")).Click();
            ...
            string xraeValidationInvalidHeightErrorText = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[2]/span")).Text.Trim();
            Assert.Contains(xraeValidationInvalidHeightErrorText, "Height must be between 122cm and 241cm");
            // and
// fails    string xraeValidationMissingWeightErrorText = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[2]/span")).Text.Trim();
// fails    Assert.Contains(xraeValidationMissingWeightErrorText, "Height and weight must be supplied together or not at all");
            ...
            bool xraeValidationErrorTextNullHeight = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[2]/span")).Displayed;
            ...
            string xraeValidationInvalidWeightErrorText = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[2]/span")).Text.Trim();
            ...
            metricHeightValue.Clear();
            string xraeValidationMissingHeightErrorText = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[2]/span")).Text.Trim();
            ...
            bool xraeValidationErrorTextNullWeight = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[15]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[2]/span")).Displayed;
            Assert.IsFalse(xraeValidationErrorTextNullWeight);


                //Assert the message on the top of the page changes to the Thnak You text:
            //Insert valid Height
            var metricValidHeightValue2 = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[15]")).FindElement(By.Id("hw.heightCentimetres"));
            ...
            driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[16]")).FindElement(By.Id("hwMetric")).Click();
            driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[16]")).FindElement(By.Id("hwImperial")).Click();
...
// fails    string xraeValidationInvalidHeightFeetErrorText = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[3]/span")).Text.Trim();
// fails    Assert.Contains(xraeValidationInvalidHeightFeetErrorText, "Height must be between 4ft 0in and 7ft 11in");
            // and
            string xraeValidationMissingWeightErrorText = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[3]/span")).Text.Trim();
            ...
            string xraeValidationInvalidHeightInchesErrorText = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[3]/span")).Text.Trim();
...
// fails    bool xraeValidationErrorTextNullImperialHeight = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[2]/div[2]/span")).Displayed;
...
// fails    string xraeValidationInvalidWeightStoneErrorText = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[3]/span")).Text.Trim();
...
// fails    string xraeValidationMissingWeightPoundsErrorText = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[16]")).FindElement(By.XPath(".//*[@id='height-and-weight']/div[3]/div[3]/span")).Text.Trim();
// fails    Assert.Contains(xraeValidationMissingWeightPoundsErrorText, "Both stone and pounds must be specified");            
            ...
            var imperialWeightPoundsValue = driver.FindElement(By.XPath(".//*[@id='ltaFormnew']/div[16]")).FindElement(By.Id("hw.weightPounds"));
